...
static void TestThrd01(void *pArg)
{
	...
	uchar rgp1[12] = {0xff,0xfe,0x64,0x01,0x00,0x02,0x00,0x01,0x02};
	uchar rgp2[12] = {0xff,0xfe,0x65,0x02,0x00,0x02,0x00,0x03,0x04};
	uchar rgp3[12] = {0xff,0xfe,0x66,0x03,0x00,0x02,0x00,0x05,0x06};
	uchar rgp4[12] = {0xff,0xfe,0x67,0x04,0x00,0x02,0x00,0x07,0x08};
	ushort crc_code = 0;
